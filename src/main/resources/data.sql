...
#                                                         (1, 'Mụn trứng cá', 'Mụn trứng cá là bệnh lý da liễu phổ biến do tắc nghẽn lỗ chân lông. Điều trị bao gồm làm sạch da, sử dụng thuốc bôi và thuốc uống nếu cần.'),
#                                                         (2, 'Viêm da cơ địa', 'Viêm da cơ địa là bệnh mạn tính gây ngứa, khô và viêm da. Điều trị tập trung vào việc dưỡng ẩm và sử dụng các loại kem bôi chống viêm.'),
#                                                         (3, 'Nám da', 'Nám da là tình trạng tăng sắc tố da, thường xuất hiện ở phụ nữ. Điều trị bao gồm sử dụng kem chống nắng, kem làm sáng da, và các liệu pháp laser.'),
#                                                         (4, 'Tổ đỉa (Eczema)', 'Tổ đỉa là một dạng chàm da, gây ra các mụn nước nhỏ, ngứa và khó chịu. Điều trị bao gồm sử dụng kem bôi và tránh các tác nhân gây dị ứng.'),
#                                                         (5, 'Sẹo lồi', 'Sẹo lồi là sự phát triển quá mức của mô sẹo. Điều trị thường kết hợp nhiều phương pháp như tiêm cortisone, liệu pháp laser hoặc phẫu thuật.');
#
# INSERT INTO treatment_steps (id, step_number, type, description, notes, disease_id) VALUES
# (1, 1, 'Examination', 'Tư vấn và khám da để xác định loại mụn và mức độ nghiêm trọng.', 'Sử dụng đèn Wood để kiểm tra vi khuẩn P.acnes.', 1),
# (2, 2, 'Topical Treatment', 'Sử dụng thuốc bôi ngoài da để giảm viêm và kiểm soát vi khuẩn.', 'Các loại thuốc phổ biến: Benzoyl Peroxide, Retinoids.', 1),
# (3, 3, 'Oral Treatment', 'Dùng kháng sinh hoặc Isotretinoin đường uống khi mụn nặng.', 'Cần theo dõi chặt chẽ các tác dụng phụ.', 1),
# (4, 4, 'Skincare', 'Hướng dẫn chăm sóc da đúng cách, bao gồm làm sạch và dưỡng ẩm.', 'Sản phẩm không chứa cồn, không gây bít tắc lỗ chân lông.', 1),
# (5, 1, 'Moisturizing', 'Sử dụng kem dưỡng ẩm chuyên sâu để phục hồi hàng rào bảo vệ da.', 'Dùng ngay sau khi tắm để da còn ẩm.', 2),
# (6, 2, 'Topical Treatment', 'Thoa kem steroid hoặc kem bôi không steroid để giảm viêm và ngứa.', 'Sử dụng theo chỉ định của bác sĩ.', 2),
# (7, 3, 'Lifestyle Advice', 'Tư vấn tránh các tác nhân gây dị ứng và thay đổi lối sống.', 'Hạn chế tắm nước quá nóng, chọn quần áo cotton.', 3),
# (8, 1, 'Sun Protection', 'Sử dụng kem chống nắng phổ rộng hàng ngày.', 'Đây là bước quan trọng nhất để ngăn nám sạm thêm.', 3),
# (9, 2, 'Topical Treatment', 'Sử dụng kem làm sáng da chứa các hoạt chất như Hydroquinone, Tretinoin.', 'Chỉ dùng vào buổi tối, tránh ánh nắng mặt trời.', 3),
# (10, 3, 'Laser Treatment', 'Liệu pháp laser (như Pico Laser) để phá hủy các sắc tố melanin.', 'Cần thực hiện theo liệu trình và có thời gian phục hồi.', 3);
#
# INSERT INTO medications (medication_id, medication_name, name, form, price, dosage, dosage_info, usage_instructions, notes, created_at, updated_at, step_id) VALUES
# (1, 'Differin Gel', 'Adapalene 0.1%', 'Gel', 180000.00, '0.1%', 'Thoa một lớp mỏng 1 lần/ngày vào buổi tối.', 'Rửa mặt sạch trước khi thoa thuốc, tránh vùng mắt và môi.', 'Chứa Adapalene, giúp giảm mụn và ngăn ngừa mụn mới.', NOW(), NOW(), 2),
# (2, 'Benzoyl Peroxide 5%', 'Benzoyl Peroxide', 'Kem', 120000.00, '5%', 'Sử dụng 1-2 lần/ngày.', 'Bôi lên vùng da bị mụn, có thể gây khô da.', 'Tác dụng diệt khuẩn P.acnes.', NOW(), NOW(), 2),
# (3, 'Doxycycline', 'Doxycycline', 'Viên uống', 250000.00, '100mg', 'Uống 1 viên/ngày, sau bữa ăn.', 'Uống với nhiều nước, tránh nằm ngay sau khi uống.', 'Kháng sinh nhóm Tetracycline, dùng trong trường hợp mụn viêm nặng.', NOW(), NOW(), 3),
# (4, 'Cetaphil Restoraderm', 'Cetaphil', 'Sữa tắm', 300000.00, '295ml', 'Dùng hàng ngày để làm sạch và giữ ẩm cho da.', 'Tắm với nước ấm, không chà xát mạnh.', 'Sản phẩm dành cho da nhạy cảm và viêm da cơ địa.', NOW(), NOW(), 5),
# (5, 'Elidel Cream', 'Pimecrolimus', 'Kem bôi', 550000.00, '1%', 'Thoa 2 lần/ngày, vào buổi sáng và buổi tối.', 'Sản phẩm không steroid, phù hợp cho vùng da nhạy cảm như mặt.', 'Chứa Pimecrolimus, giúp giảm viêm và ngứa.', NOW(), NOW(), 6),
# (6, 'Hydrocortisone Ointment', 'Hydrocortisone', 'Thuốc mỡ', 45000.00, '1%', 'Bôi 1 lần/ngày vào buổi tối trong đợt bùng phát.', 'Không dùng quá 2 tuần liên tục.', 'Steroid nhẹ, có tác dụng chống viêm hiệu quả.', NOW(), NOW(), 6),
# (7, 'Obagi Nu-Derm Clear', 'Hydroquinone 4%', 'Kem', 1500000.00, '4%', 'Thoa 1 lần/ngày vào buổi tối.', 'Chứa Hydroquinone 4%, cần có sự hướng dẫn của bác sĩ.', 'Sản phẩm chuyên sâu điều trị nám da.', NOW(), NOW(), 9),
# (8, 'Melano CC Essence', 'Vitamin C', 'Tinh chất', 350000.00, '20ml', 'Thoa 1 lần/ngày, vào buổi sáng.', 'Chứa Vitamin C, giúp làm sáng da và mờ thâm nám.', 'Sản phẩm của Nhật Bản, được ưa chuộng.', NOW(), NOW(), 9);